...
public class DoctorDetailRecyclerAdapter extends RecyclerView.Adapter<DoctorDetailViewHolder> implements SectionIndexer {

    private ArrayList<DoctorData> list;
    private RecyclerItemClickListener listener;

    public DoctorDetailRecyclerAdapter setList(ArrayList<DoctorData> list) {
        this.list = list;
        return this;
    }

    public DoctorDetailRecyclerAdapter setListener(RecyclerItemClickListener listener) {
